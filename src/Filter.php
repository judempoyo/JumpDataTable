...
/**
 * Represents a filter for a DataTable
 * 
 * Filters allow users to narrow down the data displayed in the table
 * and can be of different types (text, select, date, etc.)
 */
class Filter
{
    /** @var string The filter name (matches the data key) */
    private string $name;
    
    /** @var string The label to display for the filter */
